...
# User chose to stop for the night
        ...
        native_travel_distance += native_travel
...
# Create fail reasons for thirst
    if 4 <= thirst < 6:
...
# Create fail conditions for camel
    if 5 < camel_exhaustion <= 8:
        print("Your camel is getting tired. You should rest.")
    elif camel_exhaustion > 8:
        print("Your camel is dead.")
        print("Game over.")
        done = True

# Create fail condition for natives catching up
    if miles_traveled <= native_travel_distance >= miles_traveled:
        print("The natives have caught you.")
        print("Game over.")
        done = True
    elif miles_traveled - native_travel_distance < 15:
...
# Random Oasis scenario
    if random.randint(0, 20) == 20:
        print("You found a secret oasis!")
        print("Your canteen, thirst, and camel exhaustion has been reset!")
        thirst = 0
        camel_exhaustion = 0
        drinks_in_canteen = 5
